...
In general, this tool runs on Windows 7 and Windows 8/8.1 as well. You just need to separately install the .NET Framework 4.8 runtime on those Windows versions (you can download the runtime from the Microsoft). That's all.
