...
It's possible to change the input source of a computer's display/monitor by software (in contrast to the hardware buttons of your display/monitor). Typically by using DDC/CI commands. The DDC VCP60 command is the key component here.
