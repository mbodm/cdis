...
- An empty NET48 console application is ~7KB in size (obligatory _framework-dependent_).
...
- Most of the best features of modern .NET, publish/deployment-wise, are a result of SSPF.
