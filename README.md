...
- An empty NET48 console application is ~7KB in size (_framework-dependent_ in general)
...
- Most of the best features of modern .NET platform, publish/deployment-wise, base on SSPF.
