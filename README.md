...
Check out the other DDC/CI tools out there, like in example NirSoft's fantastic  [MonitorControl](https://www.nirsoft.net/utils/control_my_monitor.html), if you are looking for better multi-monitor support. Also [ddcutil](https://www.ddcutil.com/windows_programs/) has a nice list. Sorry `cdis.exe` can't help you here.
