...
- In modern .NET platform "_framework-dependent_" means "app needs a runtime".
...
- An empty NET48 console application is ~7KB in size (it's _framework-dependent_ in general)
