...
- A NET48 project can also make use of modern SSPF (for "_How?_" see the [section](#2-how-to-use-sdk-style-project-format-for-a-net-48-framework-project) below).
